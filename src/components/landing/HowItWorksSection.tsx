            ...
            return (
              ...
              >
                ...
                `}>
                  ...
                  {step.example && (
                    <div className="mt-6 p-3 bg-background/50 rounded-lg border border-accent/20">
        ...
        <div className="mt-16 max-w-3xl mx-auto">
          <div className="glassmorphism rounded-2xl p-8 border-accent/30">
            ...
            <div className="space-y-3 font-mono text-sm">
              ...
              <div className="flex items-start gap-3 animate-slide-up" style={{ animationDelay: '0.6s' }}>
